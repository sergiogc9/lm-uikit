...
const Select: React.FC<ComponentProps> = props => {
  ...
  return (
    <ReactSelect
      {...props}
      className='lm-ui-select-container'
      classNamePrefix='lm-ui-select'
      components={{ DropdownIndicator }}
      theme={theme => ({
        ...theme,
        colors: {
          ...
          primary75: palette.primary!.main!,
          primary55: palette.primary!.main!,
          primary25: palette.primary!.light!
        },
      })}
    />
  );
